...
class AccessTokenTestCCG extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage You must pass the options: scope, authenticating_institution_id, context_institution_id, to construct an Access Token using the client_credential grant type
     */
